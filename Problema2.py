...
def obtener_encabezado(img, ver_bin = False, ver_campos = False):
    ...
    #Umbralamos el resultado para obtener los indices adecuados
    sum_rows_bin = sum_rows > 300 #Lineas de mas de 300 pixeles
...
def obtener_letra(rta, ver_bin = False, ver_letra = False):
...
plt.savefig(r'Imagenes Obtenidas\Resultados de los examenes.png')